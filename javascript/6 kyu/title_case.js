...
The list of minor words will be given as a string with each word separated by a space. Your function should ignore the case of the 
...
###Arguments 
    ...
    lowercase except for the first word in the string. The JavaScript/CoffeeScript tests will pass undefined when this argument is unused.
...
const titleCase = (title, minorWords = '') => {
  ...
  return title.split(' ').map((word, i) => {
    ...
    if (i != 0 && minorWordsSplit.includes(word)) return word;
